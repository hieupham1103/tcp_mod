...
class Transformer(nn.Module):
    def __init__(self, width: int, layers: int, heads: int, attn_mask: torch.Tensor = None, prompts_needed=0,
        ...
        current_trainer = design_details['trainer'] if design_details else None
        if current_trainer == 'TCP_MOD_MaPLe':
...
class CLIP(nn.Module):
    def __init__(self,
        ...
        trainer = design_details['trainer'] if design_details else None
